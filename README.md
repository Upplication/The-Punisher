...
- [x] Como Administrador quiero añadir un castigo mediante un título y una descripción.
 ...
 - [ ] Como Administrador quiero ver una pantalla donde introducir el título y la descripción y un botón enviar para guardar el objetos
 ...
 - -- [ ] Como Administrador si no relleno el campo descripción y pulso en envíar se muestra un mensaje indicando que la descripción es obligatorio.
